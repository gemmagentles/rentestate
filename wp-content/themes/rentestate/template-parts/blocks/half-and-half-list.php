...
<div class="half-and-half-list__wrapper">
    <?php while ( have_rows( 'half_and_half_list_block' ) ) : the_row(); ?>
        <div class="half-and-half-list__text-half">
            ...
            <?php if ( $button_link ) { ?>
                <a class="half-and-half-list__text-button" href="<?php echo $button_link['url']; ?>" target="<?php echo $button_link['target']; ?>"><?php echo $button_link['title']; ?></a>
            <?php } ?>
        </div>
        <div class="half-and-half-list__list-half">
            ...
            <?php if ( $list_button_link ) { ?>
                <a class="half-and-half-list__list-button" href="<?php echo $list_button_link['url']; ?>" target="<?php echo $list_button_link['target']; ?>"><?php echo $list_button_link['title']; ?></a>
            <?php } ?>
        </div>        
    <?php endwhile; ?>
</div>
